package br.ufpe.cin.android.podcast.Adapters.Holders
...
class FeedItemHolder(item: View) : RecyclerView.ViewHolder(item), View.OnClickListener {
    ...
    fun bind(itemFeed: ItemFeed, context: Context) {
        ...
        podcastDownloadLinkView!!.setOnClickListener {
            Toast.makeText(context, "Baixando link = ${itemFeed.downloadLink}", Toast.LENGTH_SHORT)
                .show()
        }
    }
    ...
    override fun onClick(v: View) {
        ...
        intent.putExtra("episode_title", podcastTitleView!!.text)
        intent.putExtra("episode_pub_date", podcastPubDateView!!.text)
